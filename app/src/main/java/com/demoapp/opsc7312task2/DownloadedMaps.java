...
public class DownloadedMaps extends AppCompatActivity
{
            ...
            public void onMapReady(@NonNull MapboxMap mapboxMap)
            {
                ...
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded()
                {
                    ...
                    public void onStyleLoaded(@NonNull Style style)
                    {
                        ...
                        offlineManager = OfflineManager.getInstance(DownloadedMaps.this);
    ...
    private void downloadRegionDialog()
    {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(DownloadedMaps.this);

        final EditText regionNameEdit = new EditText(DownloadedMaps.this);
                ...
                .setPositiveButton(getString(R.string.dialog_positive_button), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (regionName.length() == 0) {
                            Toast.makeText(DownloadedMaps.this, getString(R.string.dialog_toast), Toast.LENGTH_SHORT).show();
                        } else {
    ...
    private void downloadRegion(final String regionName)
    {
        ...
        map.getStyle(new Style.OnStyleLoaded()
        {
            ...
            public void onStyleLoaded(@NonNull Style style)
            {
                ...
                float pixelRatio = DownloadedMaps.this.getResources().getDisplayMetrics().density;
                ...
                offlineManager.createOfflineRegion(definition, metadata, new OfflineManager.CreateOfflineRegionCallback() {
                    ...
                    public void onCreate(OfflineRegion offlineRegion)
                    {
                        ...
                        DownloadedMaps.this.offlineRegion = offlineRegion;
                        launchDownload();
                    }
    ...
    private void downloadedRegionList() {
        ...
        offlineManager.listOfflineRegions(new OfflineManager.ListOfflineRegionsCallback() {
            ...
            public void onList(final OfflineRegion[] offlineRegions) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(DownloadedMaps.this)
                        ...
                        .setPositiveButton(getString(R.string.navigate_positive_button), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Toast.makeText(DownloadedMaps.this, items[regionSelected], Toast.LENGTH_LONG).show();
    ...
    private void endProgress(final String message) {
        ...
        // Show a toast
        Toast.makeText(DownloadedMaps.this, message, Toast.LENGTH_LONG).show();
    }
}